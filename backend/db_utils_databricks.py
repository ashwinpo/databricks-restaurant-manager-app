"""
Database utilities for Databricks Apps environment.
Uses OAuth authentication provided automatically by Databricks Apps.
Optimized for Panda Restaurant Group data schema.
"""
...
# Configuration for Panda Restaurant Group
DEFAULT_CATALOG = os.getenv('DATABRICKS_CATALOG', 'users')
DEFAULT_SCHEMA = os.getenv('DATABRICKS_SCHEMA', 'aarthi_shankar')
...
def get_connection():
    """Get a Databricks SQL connection using OAuth authentication in Databricks Apps."""
    # In Databricks Apps, authentication is handled automatically
    # The SDK will use the provided OAuth credentials
    cfg = Config()
